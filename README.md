...
jobs:
  lint:
    uses: rubykatzen/baseline/.github/workflows/lint-shared.yml@v0.16.0
```
...
jobs:
  github:
    uses: rubykatzen/baseline/.github/workflows/github-shared.yml@v0.16.0
```
...
jobs:
  embedder:
    uses: rubykatzen/baseline/.github/workflows/embedder-shared.yml@v0.16.0
```
...
jobs:
  notify:
    uses: rubykatzen/baseline/.github/workflows/notify-telegram-pr-shared.yml@v0.16.0
    secrets:
...
jobs:
  notify:
    uses: rubykatzen/baseline/.github/workflows/notify-telegram-release-shared.yml@v0.16.0
    secrets:
      TELEGRAM_BOT_TOKEN: ${{ secrets.TELEGRAM_BOT_TOKEN }}
      TELEGRAM_CHAT_ID: ${{ secrets.TELEGRAM_CHAT_ID }}
```
...
jobs:
  notify:
    ...
    uses: rubykatzen/baseline/.github/workflows/notify-telegram-issue-shared.yml@v0.16.0
    secrets:
      TELEGRAM_BOT_TOKEN: ${{ secrets.TELEGRAM_BOT_TOKEN }}
