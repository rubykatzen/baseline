...
jobs:
  lint:
    uses: rubykatzen/baseline/.github/workflows/lint-shared.yml@v0.17.0
```
...
jobs:
  github:
    permissions:
      contents: read
      issues: read
    uses: rubykatzen/baseline/.github/workflows/github-shared.yml@v0.17.0
```
...
jobs:
  embedder:
    uses: rubykatzen/baseline/.github/workflows/embedder-shared.yml@v0.17.0
```
...
jobs:
  notify:
    ...
    uses: rubykatzen/baseline/.github/workflows/notify-telegram-issue-shared.yml@v0.17.0
    with:
